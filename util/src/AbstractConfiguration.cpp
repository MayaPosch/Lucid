...
#include "lucid/Util/AbstractConfiguration.h"
#include "lucid/Util/ConfigurationView.h"
...
using Lucid::SyntaxException;
using Lucid::CircularReferenceException;
...
{
	throw Lucid::NotImplementedException("removeRaw()");
}
