...
class Util_API AbstractConfiguration: public Lucid::RefCountedObject
...
public:
	...
	Lucid::BasicEvent<KeyValue> propertyChanging;
	...
	Lucid::BasicEvent<const KeyValue> propertyChanged;
		/// Fired after a property value has been changed
		/// or a property has been created.

	Lucid::BasicEvent<const std::string> propertyRemoving;
	...
	Lucid::BasicEvent<const std::string> propertyRemoved;
...
protected:
	...
	virtual void removeRaw(const std::string& key);
		...
		/// implementation throws a Lucid::NotImplementedException.
