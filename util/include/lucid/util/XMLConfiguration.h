...
public:
	...
	XMLConfiguration(Lucid::XML::InputSource* pInputSource);
		/// Creates an XMLConfiguration and loads the XML document from
		/// the given InputSource.

	XMLConfiguration(Lucid::XML::InputSource* pInputSource, char delim);
		/// Creates an XMLConfiguration and loads the XML document from
	...
	XMLConfiguration(const Lucid::XML::Document* pDocument);
		/// Creates the XMLConfiguration using the given XML document.

	XMLConfiguration(const Lucid::XML::Document* pDocument, char delim);
		/// Creates the XMLConfiguration using the given XML document.
		/// Uses the given delimiter char instead of the default '.'.
		
	XMLConfiguration(const Lucid::XML::Node* pNode);
		/// Creates the XMLConfiguration using the given XML node.

	XMLConfiguration(const Lucid::XML::Node* pNode, char delim);
		/// Creates the XMLConfiguration using the given XML node.
		/// Uses the given delimiter char instead of the default '.'.

	void load(Lucid::XML::InputSource* pInputSource);
		/// Loads the XML document containing the configuration data
		/// from the given InputSource.

	void load(Lucid::XML::InputSource* pInputSource, unsigned long namePoolSize);
		/// Loads the XML document containing the configuration data
	...
	void load(const Lucid::XML::Document* pDocument);
		/// Loads the XML document containing the configuration data
		/// from the given XML document.

	void load(const Lucid::XML::Node* pNode);
		/// Loads the XML document containing the configuration data
	...
	void save(Lucid::XML::DOMWriter& writer, const std::string& path) const;
		/// Writes the XML document containing the configuration data
		/// to the file given by path, using the given DOMWriter.
		///
		/// This can be used to use a DOMWriter with custom options.

	void save(Lucid::XML::DOMWriter& writer, std::ostream& str) const;
		/// Writes the XML document containing the configuration data
		/// to the given stream.
		///
		/// This can be used to use a DOMWriter with custom options.
...
private:
	const Lucid::XML::Node* findNode(const std::string& key) const;
	Lucid::XML::Node* findNode(const std::string& key);
	Lucid::XML::Node* findNode(std::string::const_iterator& it, const std::string::const_iterator& end, Lucid::XML::Node* pNode, bool create = false) const;
	static Lucid::XML::Node* findElement(const std::string& name, Lucid::XML::Node* pNode, bool create);
	static Lucid::XML::Node* findElement(int index, Lucid::XML::Node* pNode, bool create);
	static Lucid::XML::Node* findElement(const std::string& attr, const std::string& value, Lucid::XML::Node* pNode);
	static Lucid::XML::Node* findAttribute(const std::string& name, Lucid::XML::Node* pNode, bool create);

	Lucid::XML::AutoPtr<Lucid::XML::Node>     _pRoot;
	Lucid::XML::AutoPtr<Lucid::XML::Document> _pDocument;
	char _delim;
};
