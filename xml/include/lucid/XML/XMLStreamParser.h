...
#include "lucid/XML/QName.h"
#include "lucid/XML/ValueTraits.h"
#include "lucid/XML/Content.h"
...
inline Lucid::UInt64 XMLStreamParser::line() const
{
	return _line;
}


inline Lucid::UInt64 XMLStreamParser::column() const
{
	return _column;
}
