...
#include "lucid/SAX/ContentHandler.h"
#include "lucid/SAX/LexicalHandler.h"
#include "lucid/SAX/DTDHandler.h"
#include "lucid/SAX/NamespaceSupport.h"
#include "lucid/XML/XMLString.h"
#include "lucid/XML/XMLStream.h"
#include "lucid/XML/Name.h"
#include "lucid/TextEncoding.h"
#include "lucid/StreamConverter.h"
#include <vector>
#include <map>
...
public:
	...
	XMLWriter(XMLByteOutputStream& str, int options, const std::string& encodingName, Lucid::TextEncoding& textEncoding);
		/// Creates the XMLWriter and sets the specified options.
		///
	...
	XMLWriter(XMLByteOutputStream& str, int options, const std::string& encodingName, Lucid::TextEncoding* pTextEncoding);
		/// Creates the XMLWriter and sets the specified options.
		///
		/// The encoding is reflected in the XML declaration.
		/// The caller is responsible for that the given encodingName matches with
...
private:
	...
	Lucid::OutputStreamConverter* _pTextConverter;
	Lucid::TextEncoding*          _pInEncoding;
	Lucid::TextEncoding*          _pOutEncoding;
	int              _options;
