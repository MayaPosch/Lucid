...
SAXParseException::SAXParseException(const std::string& msg, const Locator& loc, const Lucid::Exception& exc):
...
SAXParseException::SAXParseException(const std::string& msg, const XMLString& publicId, const XMLString& systemId, int lineNumber, int columnNumber, const Lucid::Exception& exc):
...
Lucid::Exception* SAXParseException::clone() const
{
