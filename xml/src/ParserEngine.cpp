...
#include "lucid/XML/ParserEngine.h"
#include "lucid/XML/NamespaceStrategy.h"
...
#include "lucid/SAX/DeclHandler.h"
#include "lucid/SAX/ContentHandler.h"
#include "lucid/SAX/LexicalHandler.h"
#include "lucid/SAX/ErrorHandler.h"
#include "lucid/SAX/InputSource.h"
#include "lucid/SAX/Locator.h"
#include "lucid/SAX/LocatorImpl.h"
#include "lucid/SAX/SAXException.h"
#include "lucid/URI.h"
#include <cstring>


using Lucid::URI;
using Lucid::TextEncoding;
...
int ParserEngine::handleUnknownEncoding(void* encodingHandlerData, const XML_Char* name, XML_Encoding* info)
{
	...
	if (it != pThis->_encodings.end())
		...
		knownEncoding = Lucid::TextEncoding::find(fromXMLString(encoding));
