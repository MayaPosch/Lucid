...
HTTPClientSession* HTTPSessionInstantiator::createClientSession(const Lucid::URI& uri)
{
...
void HTTPSessionInstantiator::setProxy(const std::string& host, Lucid::UInt16 port)
{
	_proxyHost = host;
	_proxyPort = port;
}
