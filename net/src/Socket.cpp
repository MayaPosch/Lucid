...
int Socket::select(SocketList& readList, SocketList& writeList, SocketList& exceptList, const Lucid::Timespan& timeout)
{
#if defined(POCO_HAVE_FD_EPOLL)
...
#elif defined(POCO_HAVE_FD_POLL)
	typedef Lucid::SharedPtr<pollfd, Lucid::ReferenceCounter, Lucid::ReleaseArrayPolicy<pollfd>> SharedPollArray;
