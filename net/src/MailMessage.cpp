...
#include "lucid/Net/MediaType.h"
#include "lucid/Net/MultipartReader.h"
#include "lucid/Net/MultipartWriter.h"
#include "lucid/Net/PartSource.h"
#include "lucid/Net/PartHandler.h"
#include "lucid/Net/StringPartSource.h"
#include "lucid/Net/QuotedPrintableEncoder.h"
...
namespace
{
	...
	public:
		...
		{
			std::string tmp;
			Lucid::StreamCopier::copyToString(stream, tmp);
			if (_pMsg)
			{
...
void MailMessage::setDate(const Lucid::Timestamp& dateTime)
{
	set(HEADER_DATE, DateTimeFormatter::format(dateTime, DateTimeFormat::RFC1123_FORMAT));
}

	
Lucid::Timestamp MailMessage::getDate() const
{
