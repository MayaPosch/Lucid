...
void StreamSocket::connect(const SocketAddress& address, const Lucid::Timespan& timeout)
{
...
int StreamSocket::receiveBytes(Lucid::Buffer<char>& buffer, int flags, const Lucid::Timespan& timeout)
{
