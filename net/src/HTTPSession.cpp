...
void HTTPSession::setTimeout(const Lucid::Timespan& timeout)
{
	setTimeout(timeout, timeout, timeout);
}


void HTTPSession::setTimeout(const Lucid::Timespan& connectionTimeout, const Lucid::Timespan& sendTimeout, const Lucid::Timespan& receiveTimeout)
{
...
void HTTPSession::setException(const Lucid::Exception& exc)
{
	delete _pException;
...
void HTTPSession::attachSessionData(const Lucid::Any& data)
{
	_data = data;
}


void HTTPSession::drainBuffer(Lucid::Buffer<char>& buffer)
{
