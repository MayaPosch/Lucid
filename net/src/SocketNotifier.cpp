...
void SocketNotifier::addObserver(SocketReactor* pReactor, const Lucid::AbstractObserver& observer)
{
...
void SocketNotifier::removeObserver(SocketReactor* pReactor, const Lucid::AbstractObserver& observer)
{
