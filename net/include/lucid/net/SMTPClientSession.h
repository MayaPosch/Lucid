...
public:
	...
	SMTPClientSession(const std::string& host, Lucid::UInt16 port = SMTP_PORT);
...
protected:
	...
	void loginUsingCRAM(const std::string& username, const std::string& method, Lucid::DigestEngine& hmac);
