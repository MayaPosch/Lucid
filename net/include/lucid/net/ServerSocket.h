...
public:
	...
	ServerSocket(Lucid::UInt16 port, int backlog = 64);
		/// Creates a server socket, binds it
	...
	virtual void bind(Lucid::UInt16 port, bool reuseAddress = false);
	...
	virtual void bind(Lucid::UInt16 port, bool reuseAddress, bool reusePort);
		/// Binds a local port to the socket.
		///
		/// This is usually only done when establishing a server
		/// socket. 
	...
	virtual void bind6(Lucid::UInt16 port, bool reuseAddress = false, bool ipV6Only = false);
	...
	virtual void bind6(Lucid::UInt16 port, bool reuseAddress, bool reusePort, bool ipV6Only);
		/// Binds a local IPv6 port to the socket.
		///
		/// This is usually only done when establishing a server
		/// socket. 
