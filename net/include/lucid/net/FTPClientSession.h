...
#include "lucid/Net/DialogSocket.h"
...
public:
	...
	FTPClientSession(const std::string& host, Lucid::UInt16 port = FTP_PORT, const std::string& username = "", const std::string& password = "");
	...
	virtual void open(const std::string& host, Lucid::UInt16 port, const std::string& username = "", const std::string& password = "");
