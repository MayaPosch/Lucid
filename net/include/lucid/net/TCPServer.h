...
class Net_API TCPServerConnectionFilter: public Lucid::RefCountedObject
...
{
public:
	using Ptr = Lucid::AutoPtr<TCPServerConnectionFilter>;
...
class Net_API TCPServer: public Lucid::Runnable
...
{
public:
	TCPServer(TCPServerConnectionFactory::Ptr pFactory, Lucid::UInt16 portNumber = 0, TCPServerParams::Ptr pParams = 0);
	...
	TCPServer(TCPServerConnectionFactory::Ptr pFactory, Lucid::ThreadPool& threadPool, const ServerSocket& socket, TCPServerParams::Ptr pParams = 0);
		/// Creates the TCPServer, using the given ServerSocket.
		///
		/// The server takes ownership of the TCPServerConnectionFactory
		/// and deletes it when it's no longer needed.
...
inline Lucid::UInt16 TCPServer::port() const
{
