...
#include "lucid/Net/IPAddressImpl.h"
...
public:
	...
	IPAddress(const void* addr, poco_socklen_t length, Lucid::UInt32 scope);
		/// Creates an IPAddress from a native internet address.
		/// A pointer to a in_addr or a in6_addr structure may be 
...
private:
	typedef Lucid::Net::Impl::IPAddressImpl Impl;
	...
	void newIPv6(const void* hostAddr, Lucid::UInt32 scope);
...
{
	_pImpl = new Lucid::Net::Impl::IPv4AddressImpl;
}


inline void IPAddress::newIPv4(const void* hostAddr)
{
	_pImpl = new Lucid::Net::Impl::IPv4AddressImpl(hostAddr);
}


inline void IPAddress::newIPv4(unsigned prefix)
{
	_pImpl = new Lucid::Net::Impl::IPv4AddressImpl(prefix);
}
...
{
	_pImpl = new Lucid::Net::Impl::IPv6AddressImpl;
}


inline void IPAddress::newIPv6(const void* hostAddr)
{
	_pImpl = new Lucid::Net::Impl::IPv6AddressImpl(hostAddr);
}


inline void IPAddress::newIPv6(const void* hostAddr, Lucid::UInt32 scope)
{
	_pImpl = new Lucid::Net::Impl::IPv6AddressImpl(hostAddr, scope);
}


inline void IPAddress::newIPv6(unsigned prefix)
{
	_pImpl = new Lucid::Net::Impl::IPv6AddressImpl(prefix);
}
...
Net_API Lucid::BinaryWriter& operator << (Lucid::BinaryWriter& writer, const Lucid::Net::IPAddress& value);
Net_API Lucid::BinaryReader& operator >> (Lucid::BinaryReader& reader, Lucid::Net::IPAddress& value);
Net_API std::ostream& operator << (std::ostream& ostr, const Lucid::Net::IPAddress& addr);
