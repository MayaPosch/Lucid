...
public:
	...
	virtual HTTPClientSession* createClientSession(const Lucid::URI& uri);
...
protected:
	void setProxy(const std::string& host, Lucid::UInt16 port);
...
inline Lucid::UInt16 HTTPSessionInstantiator::proxyPort() const
{
	return _proxyPort;
}
