...
public:
	...
	static int select(SocketList& readList, SocketList& writeList, SocketList& exceptList, const Lucid::Timespan& timeout);
	...
	bool poll(const Lucid::Timespan& timeout, int mode) const;
	...
	void setSendTimeout(const Lucid::Timespan& timeout);
		/// Sets the send timeout for the socket.
	
	Lucid::Timespan getSendTimeout() const;
	...
	void setReceiveTimeout(const Lucid::Timespan& timeout);
		/// Sets the send timeout for the socket.
		///
		/// On systems that do not support SO_RCVTIMEO, a
		/// workaround using poll() is provided.
	
	Lucid::Timespan getReceiveTimeout() const;
	...
	void setOption(int level, int option, const Lucid::Timespan& value);
		/// Sets the socket option specified by level and option
	...
	void getOption(int level, int option, Lucid::Timespan& value) const;
		/// Returns the value of the socket option 
		/// specified by level and option.
...
inline bool Socket::poll(const Lucid::Timespan& timeout, int mode) const
{
...
inline void Socket::setSendTimeout(const Lucid::Timespan& timeout)
{
	_pImpl->setSendTimeout(timeout);
}


inline Lucid::Timespan Socket::getSendTimeout() const
{
	return _pImpl->getSendTimeout();
}


inline void Socket::setReceiveTimeout(const Lucid::Timespan& timeout)
{
	_pImpl->setReceiveTimeout(timeout);
}


inline Lucid::Timespan Socket::getReceiveTimeout() const
{
...
inline void Socket::setOption(int level, int option, const Lucid::Timespan& value)
{
	_pImpl->setOption(level, option, value);
}
...
inline void Socket::getOption(int level, int option, Lucid::Timespan& value) const
{
	_pImpl->getOption(level, option, value);
}
