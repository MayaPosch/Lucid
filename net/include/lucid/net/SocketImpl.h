...
class Net_API SocketImpl: public Lucid::RefCountedObject
...
public:
	...
	virtual void connect(const SocketAddress& address, const Lucid::Timespan& timeout);
	...
	virtual void bind6(const SocketAddress& address, bool reuseAddress = false, bool ipV6Only = false);
		...
		/// a Lucid::NotImplementedException will be thrown.
	...
	virtual int receiveBytes(Lucid::Buffer<char>& buffer, int flags = 0, const Lucid::Timespan& timeout = 100000);
	...
	virtual bool poll(const Lucid::Timespan& timeout, int mode);
	...
	virtual void setSendTimeout(const Lucid::Timespan& timeout);
		/// Sets the send timeout for the socket.

	virtual Lucid::Timespan getSendTimeout();
	...
	void getOption(int level, int option, Lucid::Timespan& value);
		/// Returns the value of the socket option
		/// specified by level and option.
...
private:
	...
	Lucid::Timespan _recvTimeout;
	Lucid::Timespan _sndTimeout;
	bool           _blocking;
