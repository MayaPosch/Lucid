...
class Net_API SocketAddressImpl : public Lucid::RefCountedObject
{
public:
...
{
	throw Lucid::InvalidAccessException("local socket address does not have host IP address");
}


inline UInt16 LocalSocketAddressImpl::port() const
{
	throw Lucid::InvalidAccessException("local socket address does not have port number");
}
