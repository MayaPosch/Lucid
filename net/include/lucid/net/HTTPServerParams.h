...
{
public:
	using Ptr = Lucid::AutoPtr<HTTPServerParams>;
...
inline const Lucid::Timespan& HTTPServerParams::getTimeout() const
{
	return _timeout;
}
...
inline const Lucid::Timespan& HTTPServerParams::getKeepAliveTimeout() const
{
