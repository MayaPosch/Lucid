...
public:
	...
	void authenticate(HTTPRequest& request, const Lucid::URI& uri, SignatureMethod method = SIGN_HMAC_SHA1);
		/// Adds an OAuth 1.0A Authentication header to the given request, using
		/// the given signature method.
		
	void authenticate(HTTPRequest& request, const Lucid::URI& uri, const Lucid::Net::HTMLForm& params, SignatureMethod method = SIGN_HMAC_SHA1);
		/// Adds an OAuth 1.0A Authentication header to the given request, using
		/// the given signature method.

	bool verify(const HTTPRequest& request, const Lucid::URI& uri);
	...
	bool verify(const HTTPRequest& request, const Lucid::URI& uri, const Lucid::Net::HTMLForm& params);
		/// Verifies the signature of the given request. 
		///
		/// The consumer key, consumer secret, token and token secret must have been set.
		///
...
protected:
	void signPlaintext(Lucid::Net::HTTPRequest& request) const;
		/// Signs the given HTTP request according to OAuth 1.0A PLAINTEXT signature method.

	void signHMACSHA1(Lucid::Net::HTTPRequest& request, const std::string& uri, const Lucid::Net::HTMLForm& params) const;
	...
	std::string createSignature(const Lucid::Net::HTTPRequest& request, const std::string& uri, const Lucid::Net::HTMLForm& params, const std::string& nonce, const std::string& timestamp) const;
