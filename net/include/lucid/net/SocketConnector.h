...
#include "lucid/Net/ParallelSocketAcceptor.h"
...
public:
	...
	{
		_pReactor = &reactor;
		_pReactor->addEventHandler(_socket, Lucid::Observer<SocketConnector, ReadableNotification>(*this, &SocketConnector::onReadable));
		_pReactor->addEventHandler(_socket, Lucid::Observer<SocketConnector, WritableNotification>(*this, &SocketConnector::onWritable));
		_pReactor->addEventHandler(_socket, Lucid::Observer<SocketConnector, ErrorNotification>(*this, &SocketConnector::onError));
	}
		...
		/// The overriding method must call the baseclass implementation first.
	{
		if (_pReactor)
		{
			_pReactor->removeEventHandler(_socket, Lucid::Observer<SocketConnector, ReadableNotification>(*this, &SocketConnector::onReadable));
			_pReactor->removeEventHandler(_socket, Lucid::Observer<SocketConnector, WritableNotification>(*this, &SocketConnector::onWritable));
			_pReactor->removeEventHandler(_socket, Lucid::Observer<SocketConnector, ErrorNotification>(*this, &SocketConnector::onError));
		}
	}
