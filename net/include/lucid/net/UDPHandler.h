...
public:
	...
	typedef Lucid::SpinlockMutex     DFMutex;
#else
	typedef Lucid::FastMutex         DFMutex;
#endif
	...
	static Lucid::StringTokenizer payload(char* buf, char delimiter)
	...
	{
		return Lucid::StringTokenizer(payload(buf), std::string(1, delimiter), StringTokenizer::TOK_IGNORE_EMPTY);
	}
...
private:
	...
	typedef Lucid::FastMemoryPool<char[S]>    MemPool;
