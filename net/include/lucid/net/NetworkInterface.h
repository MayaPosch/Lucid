...
public:
	...
	typedef Lucid::Tuple<IPAddress, IPAddress, IPAddress> AddressTuple;
...
Net_API std::ostream& operator << (std::ostream& ostr, const Lucid::Net::NetworkInterface::MACAddress& addr);
