...
#include "lucid/JSON/ParserImpl.h"
...
class JSON_API Parser: private ParserImpl
	...
	/// or an Array. Therefore the result of parse() is a Lucid::dynamic::Var
	/// containing a Lucid::SharedPtr to an Object or Array instance.
	///
	/// Example:
	/// 
	///    std::string json = "{ \"name\" : \"Franky\", \"children\" : [ \"Jonas\", \"Ellen\" ] }";
