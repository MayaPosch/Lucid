...
Lucid::UInt64 StreamCopier::copyStream64(std::istream& istr, std::ostream& ostr, std::size_t bufferSize)
{
	poco_assert (bufferSize > 0);
...
#if defined(POCO_HAVE_INT64)
Lucid::UInt64 StreamCopier::copyToString64(std::istream& istr, std::string& str, std::size_t bufferSize)
{
	poco_assert (bufferSize > 0);
...
#if defined(POCO_HAVE_INT64)
Lucid::UInt64 StreamCopier::copyStreamUnbuffered64(std::istream& istr, std::ostream& ostr)
{
	char c = 0;
	Lucid::UInt64 len = 0;
	istr.get(c);
