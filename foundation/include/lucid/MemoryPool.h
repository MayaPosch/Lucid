...
class FastMemoryPool
	...
	/// Lucid::MemoryPool. It is likely to be significantly faster than
	...
	/// it becomes invalid.
	///
	/// FastMemoryPool is thread safe; it uses Lucid::FastMutex by
	/// default, but other mutexes can be specified through the template
	/// parameter, if needed. Lucid::NullMutex can be specified as template
...
private:
	...
	typedef Lucid::AtomicCounter Counter;
