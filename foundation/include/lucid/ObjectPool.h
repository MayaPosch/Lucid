...
template <class C>
class PoolableObjectFactory <C, Lucid::AutoPtr<C>>
{
public:
	Lucid::AutoPtr<C> createObject()
	{
		return new C;
	}
	
	bool validateObject(Lucid::AutoPtr<C> pObject)
	{
		return true;
	}
	
	void activateObject(Lucid::AutoPtr<C> pObject)
	{
	}
	
	void deactivateObject(Lucid::AutoPtr<C> pObject)
	{
	}
	
	void destroyObject(Lucid::AutoPtr<C> pObject)
	{
	}
};
...
template <class C>
class PoolableObjectFactory <C, Lucid::SharedPtr<C>>
{
public:
	Lucid::SharedPtr<C> createObject()
	{
		return new C;
	}
	
	bool validateObject(Lucid::SharedPtr<C> pObject)
	{
		return true;
	}
	
	void activateObject(Lucid::SharedPtr<C> pObject)
	{
	}
	
	void deactivateObject(Lucid::SharedPtr<C> pObject)
	{
	}
	
	void destroyObject(Lucid::SharedPtr<C> pObject)
	{
	}
};
...
private:
	...
	std::size_t _size;
	std::vector<P> _pool;
	mutable Lucid::FastMutex _mutex;
	Lucid::Condition _availableCondition;
};
