...
#include "lucid/MetaProgramming.h"
#include <algorithm>
#include <typeinfo>
#include <cstring>
...
union Placeholder
	/// ValueHolder union (used by Lucid::Any and Lucid::dynamic::Var for small
...
class Any
	...
	///
	/// Code taken from the Boost 1.33.1 library. Original copyright by Kevlin Henney. Modified for Lucid
