...
#include "lucid/Mutex_WINCE.h"
#else
#include "lucid/Mutex_WIN32.h"
#endif
#elif defined(POCO_VXWORKS)
#include "lucid/Mutex_VX.h"
#else
#include "lucid/Mutex_POSIX.h"
#endif
...
{
public:
	using ScopedLock = Lucid::ScopedLock<Mutex>;
...
{
public:
	using ScopedLock = Lucid::ScopedLock<FastMutex>;
...
{
public:
	using ScopedLock = Lucid::ScopedLock<SpinlockMutex>;
...
{
public:
	using ScopedLock = Lucid::ScopedLock<NullMutex>;
