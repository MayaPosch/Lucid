...
#include "lucid/KeyValueArgs.h"
#include "lucid/ValidArgs.h" 
#include "lucid/Mutex.h"
#include "lucid/Exception.h"
#include "lucid/FIFOEvent.h"
#include "lucid/EventArgs.h"
#include "lucid/Delegate.h"
...
public:
	...
	void forceReplace()
		/// Forces cache replacement. Note that Lucid's cache strategy use for efficiency reason no background thread
