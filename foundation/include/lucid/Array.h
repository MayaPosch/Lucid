...
public:
	...
	reference at(size_type i)
		/// Element access with range check. Throws Lucid::InvalidArgumentException if the index is over range.
	{ 
		if(i>=size())
			throw Lucid::InvalidArgumentException("Array::at() range check failed: index is over range");
		return elems[i]; 
	}
