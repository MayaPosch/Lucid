...
#include "lucid/ActiveResult.h"
#include "lucid/ActiveMethod.h"
...
class AbstractEvent
	...
	///
	///     #include "lucid/PriorityEvent.h"
	///     #include "lucid/PriorityDelegate.h"
	///
	...
	///     {
	///     public:
	///         Lucid::BasicEvent<int> dataChanged;
	///
	///         MyData();
	///         ...
	///         void setData(int i);
...
public:
	...
	void notify(const void* pSender, TArgs& args)
		...
		/// to the caller.
	{
		Lucid::ScopedLockWithUnlock<TMutex> lock(_mutex);
