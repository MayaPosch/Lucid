...
// platforms (returned by Lucid::Thread::getMinOSPriority()).
// #define POCO_THREAD_PRIORITY_MIN 0


// Define to override system-provided
// maximum thread priority value on POSIX
// platforms (returned by Lucid::Thread::getMaxOSPriority()).
...
// to "d.so", "d.dll", etc. for _DEBUG builds in Lucid::SharedLibrary.
