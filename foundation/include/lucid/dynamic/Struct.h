...
public:
	...
	typedef typename Lucid::SharedPtr<Struct<K, M, S>> Ptr;
...
public:
	...
	void convert(Lucid::DateTime&) const
	{
		throw BadCastException("Struct -> Lucid::DateTime");
	}

	void convert(Lucid::LocalDateTime&) const
	{
		throw BadCastException("Struct -> Lucid::LocalDateTime");
	}

	void convert(Lucid::Timestamp&) const
	{
		throw BadCastException("Struct -> Lucid::Timestamp");
	}
...
template <>
class VarHolderImpl<Struct<std::string, Lucid::OrderedMap<std::string, Var>, Lucid::OrderedSet<std::string>>> : public VarHolder
{
public:
	typedef std::string KeyType;
	typedef Lucid::OrderedMap<KeyType, Var> MapType;
	typedef Lucid::OrderedSet<KeyType> SetType;
	typedef Struct<KeyType, MapType, SetType> ValueType;
...
template <>
class VarHolderImpl<Struct<int, Lucid::OrderedMap<int, Var>, Lucid::OrderedSet<int>>> : public VarHolder
{
public:
	typedef int KeyType;
	typedef Lucid::OrderedMap<KeyType, Var> MapType;
...
typedef dynamic::Struct<std::string, Lucid::OrderedMap<std::string, dynamic::Var>, Lucid::OrderedSet<std::string>> OrdereddynamicStruct;
