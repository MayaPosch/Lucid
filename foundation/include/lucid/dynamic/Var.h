...
#include "lucid/OrderedMap.h"
#include "lucid/OrderedSet.h"
#include "lucid/dynamic/VarHolder.h"
#include "lucid/dynamic/VarIterator.h"
#include <typeinfo>
#include <map>
#include <set>
...
public:
	...
	using Iterator = Lucid::dynamic::VarIterator;
...
inline Lucid::Int8 operator + (const Lucid::Int8& other, const Var& da)
	/// Addition operator for adding Var to Lucid::Int8
{
	return other + da.convert<Lucid::Int8>();
}


inline Lucid::Int8 operator - (const Lucid::Int8& other, const Var& da)
	/// Subtraction operator for subtracting Var from Lucid::Int8
{
	return other - da.convert<Lucid::Int8>();
}
...
inline Lucid::Int8 operator * (const Lucid::Int8& other, const Var& da)
	/// Multiplication operator for multiplying Var with Lucid::Int8
{
	return other * da.convert<Lucid::Int8>();
}
...
inline Lucid::Int8 operator / (const Lucid::Int8& other, const Var& da)
	/// Division operator for dividing Var with Lucid::Int8
{
	return other / da.convert<Lucid::Int8>();
}


inline Lucid::Int8 operator += (Lucid::Int8& other, const Var& da)
	/// Addition assignment operator for adding Var to Lucid::Int8
{
	return other += da.convert<Lucid::Int8>();
}
...
inline Lucid::Int8 operator -= (Lucid::Int8& other, const Var& da)
	/// Subtraction assignment operator for subtracting Var from Lucid::Int8
{
	return other -= da.convert<Lucid::Int8>();
}
...
inline Lucid::Int8 operator *= (Lucid::Int8& other, const Var& da)
	/// Multiplication assignment operator for multiplying Var with Lucid::Int8
{
	return other *= da.convert<Lucid::Int8>();
}
...
inline Lucid::Int8 operator /= (Lucid::Int8& other, const Var& da)
	/// Division assignment operator for dividing Var with Lucid::Int8
{
	return other /= da.convert<Lucid::Int8>();
}


inline bool operator == (const Lucid::Int8& other, const Var& da)
	/// Equality operator for comparing Var with Lucid::Int8
{
	if (da.isEmpty()) return false;
	return other == da.convert<Lucid::Int8>();
}
...
inline bool operator != (const Lucid::Int8& other, const Var& da)
	/// Inequality operator for comparing Var with Lucid::Int8
{
	if (da.isEmpty()) return true;
	return other != da.convert<Lucid::Int8>();
}
...
inline bool operator < (const Lucid::Int8& other, const Var& da)
	/// Less than operator for comparing Var with Lucid::Int8
{
	if (da.isEmpty()) return false;
	return other < da.convert<Lucid::Int8>();
}
...
inline bool operator <= (const Lucid::Int8& other, const Var& da)
	/// Less than or equal operator for comparing Var with Lucid::Int8
{
	if (da.isEmpty()) return false;
	return other <= da.convert<Lucid::Int8>();
}
...
inline bool operator > (const Lucid::Int8& other, const Var& da)
	/// Greater than operator for comparing Var with Lucid::Int8
{
	if (da.isEmpty()) return false;
	return other > da.convert<Lucid::Int8>();
}
...
inline bool operator >= (const Lucid::Int8& other, const Var& da)
	/// Greater than or equal operator for comparing Var with Lucid::Int8
{
	if (da.isEmpty()) return false;
	return other >= da.convert<Lucid::Int8>();
}
...
inline Lucid::UInt8 operator + (const Lucid::UInt8& other, const Var& da)
	/// Addition operator for adding Var to Lucid::UInt8
{
	return other + da.convert<Lucid::UInt8>();
}


inline Lucid::UInt8 operator - (const Lucid::UInt8& other, const Var& da)
	/// Subtraction operator for subtracting Var from Lucid::UInt8
{
	return other - da.convert<Lucid::UInt8>();
}
...
inline Lucid::UInt8 operator * (const Lucid::UInt8& other, const Var& da)
	/// Multiplication operator for multiplying Var with Lucid::UInt8
{
	return other * da.convert<Lucid::UInt8>();
}
...
inline Lucid::UInt8 operator / (const Lucid::UInt8& other, const Var& da)
	/// Division operator for dividing Var with Lucid::UInt8
{
	return other / da.convert<Lucid::UInt8>();
}


inline Lucid::UInt8 operator += (Lucid::UInt8& other, const Var& da)
	/// Addition assignment operator for adding Var to Lucid::UInt8
{
	return other += da.convert<Lucid::UInt8>();
}
...
inline Lucid::UInt8 operator -= (Lucid::UInt8& other, const Var& da)
	/// Subtraction assignment operator for subtracting Var from Lucid::UInt8
{
	return other -= da.convert<Lucid::UInt8>();
}
...
inline Lucid::UInt8 operator *= (Lucid::UInt8& other, const Var& da)
	/// Multiplication assignment operator for multiplying Var with Lucid::UInt8
{
	return other *= da.convert<Lucid::UInt8>();
}
...
inline Lucid::UInt8 operator /= (Lucid::UInt8& other, const Var& da)
	/// Division assignment operator for dividing Var with Lucid::UInt8
{
	return other /= da.convert<Lucid::UInt8>();
}


inline bool operator == (const Lucid::UInt8& other, const Var& da)
	/// Equality operator for comparing Var with Lucid::UInt8
{
	if (da.isEmpty()) return false;
	return other == da.convert<Lucid::UInt8>();
}
...
inline bool operator != (const Lucid::UInt8& other, const Var& da)
	/// Inequality operator for comparing Var with Lucid::UInt8
{
	if (da.isEmpty()) return true;
	return other != da.convert<Lucid::UInt8>();
}
...
inline bool operator < (const Lucid::UInt8& other, const Var& da)
	/// Less than operator for comparing Var with Lucid::UInt8
{
	if (da.isEmpty()) return false;
	return other < da.convert<Lucid::UInt8>();
}
...
inline bool operator <= (const Lucid::UInt8& other, const Var& da)
	/// Less than or equal operator for comparing Var with Lucid::UInt8
{
	if (da.isEmpty()) return false;
	return other <= da.convert<Lucid::UInt8>();
}
...
inline bool operator > (const Lucid::UInt8& other, const Var& da)
	/// Greater than operator for comparing Var with Lucid::UInt8
{
	if (da.isEmpty()) return false;
	return other > da.convert<Lucid::UInt8>();
}
...
inline bool operator >= (const Lucid::UInt8& other, const Var& da)
	/// Greater than or equal operator for comparing Var with Lucid::UInt8
{
	if (da.isEmpty()) return false;
	return other >= da.convert<Lucid::UInt8>();
}
...
inline Lucid::Int16 operator + (const Lucid::Int16& other, const Var& da)
	/// Addition operator for adding Var to Lucid::Int16
{
	return other + da.convert<Lucid::Int16>();
}


inline Lucid::Int16 operator - (const Lucid::Int16& other, const Var& da)
	/// Subtraction operator for subtracting Var from Lucid::Int16
{
	return other - da.convert<Lucid::Int16>();
}
...
inline Lucid::Int16 operator * (const Lucid::Int16& other, const Var& da)
	/// Multiplication operator for multiplying Var with Lucid::Int16
{
	return other * da.convert<Lucid::Int16>();
}
...
inline Lucid::Int16 operator / (const Lucid::Int16& other, const Var& da)
	/// Division operator for dividing Var with Lucid::Int16
{
	return other / da.convert<Lucid::Int16>();
}


inline Lucid::Int16 operator += (Lucid::Int16& other, const Var& da)
	/// Addition assignment operator for adding Var to Lucid::Int16
{
	return other += da.convert<Lucid::Int16>();
}
...
inline Lucid::Int16 operator -= (Lucid::Int16& other, const Var& da)
	/// Subtraction assignment operator for subtracting Var from Lucid::Int16
{
	return other -= da.convert<Lucid::Int16>();
}
...
inline Lucid::Int16 operator *= (Lucid::Int16& other, const Var& da)
	/// Multiplication assignment operator for multiplying Var with Lucid::Int16
{
	return other *= da.convert<Lucid::Int16>();
}
...
inline Lucid::Int16 operator /= (Lucid::Int16& other, const Var& da)
	/// Division assignment operator for dividing Var with Lucid::Int16
{
	return other /= da.convert<Lucid::Int16>();
}


inline bool operator == (const Lucid::Int16& other, const Var& da)
	/// Equality operator for comparing Var with Lucid::Int16
{
	if (da.isEmpty()) return false;
	return other == da.convert<Lucid::Int16>();
}
...
inline bool operator != (const Lucid::Int16& other, const Var& da)
	/// Inequality operator for comparing Var with Lucid::Int16
{
	if (da.isEmpty()) return true;
	return other != da.convert<Lucid::Int16>();
}
...
inline bool operator < (const Lucid::Int16& other, const Var& da)
	/// Less than operator for comparing Var with Lucid::Int16
{
	if (da.isEmpty()) return false;
	return other < da.convert<Lucid::Int16>();
}
...
inline bool operator <= (const Lucid::Int16& other, const Var& da)
	/// Less than or equal operator for comparing Var with Lucid::Int16
{
	if (da.isEmpty()) return false;
	return other <= da.convert<Lucid::Int16>();
}
...
inline bool operator > (const Lucid::Int16& other, const Var& da)
	/// Greater than operator for comparing Var with Lucid::Int16
{
	if (da.isEmpty()) return false;
	return other > da.convert<Lucid::Int16>();
}
...
inline bool operator >= (const Lucid::Int16& other, const Var& da)
	/// Greater than or equal operator for comparing Var with Lucid::Int16
{
	if (da.isEmpty()) return false;
	return other >= da.convert<Lucid::Int16>();
}
...
inline Lucid::UInt16 operator + (const Lucid::UInt16& other, const Var& da)
	/// Addition operator for adding Var to Lucid::UInt16
{
	return other + da.convert<Lucid::UInt16>();
}


inline Lucid::UInt16 operator - (const Lucid::UInt16& other, const Var& da)
	/// Subtraction operator for subtracting Var from Lucid::UInt16
{
	return other - da.convert<Lucid::UInt16>();
}
...
inline Lucid::UInt16 operator * (const Lucid::UInt16& other, const Var& da)
	/// Multiplication operator for multiplying Var with Lucid::UInt16
{
	return other * da.convert<Lucid::UInt16>();
}
...
inline Lucid::UInt16 operator / (const Lucid::UInt16& other, const Var& da)
	/// Division operator for dividing Var with Lucid::UInt16
{
	return other / da.convert<Lucid::UInt16>();
}


inline Lucid::UInt16 operator += (Lucid::UInt16& other, const Var& da)
	/// Addition assignment operator for adding Var to Lucid::UInt16
{
	return other += da.convert<Lucid::UInt16>();
}
...
inline Lucid::UInt16 operator -= (Lucid::UInt16& other, const Var& da)
	/// Subtraction assignment operator for subtracting Var from Lucid::UInt16
{
	return other -= da.convert<Lucid::UInt16>();
}
...
inline Lucid::UInt16 operator *= (Lucid::UInt16& other, const Var& da)
	/// Multiplication assignment operator for multiplying Var with Lucid::UInt16
{
	return other *= da.convert<Lucid::UInt16>();
}
...
inline Lucid::UInt16 operator /= (Lucid::UInt16& other, const Var& da)
	/// Division assignment operator for dividing Var with Lucid::UInt16
{
	return other /= da.convert<Lucid::UInt16>();
}


inline bool operator == (const Lucid::UInt16& other, const Var& da)
	/// Equality operator for comparing Var with Lucid::UInt16
{
	if (da.isEmpty()) return false;
	return other == da.convert<Lucid::UInt16>();
}
...
inline bool operator != (const Lucid::UInt16& other, const Var& da)
	/// Inequality operator for comparing Var with Lucid::UInt16
{
	if (da.isEmpty()) return true;
	return other != da.convert<Lucid::UInt16>();
}
...
inline bool operator < (const Lucid::UInt16& other, const Var& da)
	/// Less than operator for comparing Var with Lucid::UInt16
{
	if (da.isEmpty()) return false;
	return other < da.convert<Lucid::UInt16>();
}
...
inline bool operator <= (const Lucid::UInt16& other, const Var& da)
	/// Less than or equal operator for comparing Var with Lucid::UInt16
{
	if (da.isEmpty()) return false;
	return other <= da.convert<Lucid::UInt16>();
}
...
inline bool operator > (const Lucid::UInt16& other, const Var& da)
	/// Greater than operator for comparing Var with Lucid::UInt16
{
	if (da.isEmpty()) return false;
	return other > da.convert<Lucid::UInt16>();
}
...
inline bool operator >= (const Lucid::UInt16& other, const Var& da)
	/// Greater than or equal operator for comparing Var with Lucid::UInt16
{
	if (da.isEmpty()) return false;
	return other >= da.convert<Lucid::UInt16>();
}
...
inline Lucid::Int32 operator + (const Lucid::Int32& other, const Var& da)
	/// Addition operator for adding Var to Lucid::Int32
{
	return other + da.convert<Lucid::Int32>();
}


inline Lucid::Int32 operator - (const Lucid::Int32& other, const Var& da)
	/// Subtraction operator for subtracting Var from Lucid::Int32
{
	return other - da.convert<Lucid::Int32>();
}
...
inline Lucid::Int32 operator * (const Lucid::Int32& other, const Var& da)
	/// Multiplication operator for multiplying Var with Lucid::Int32
{
	return other * da.convert<Lucid::Int32>();
}
...
inline Lucid::Int32 operator / (const Lucid::Int32& other, const Var& da)
	/// Division operator for dividing Var with Lucid::Int32
{
	return other / da.convert<Lucid::Int32>();
}


inline Lucid::Int32 operator += (Lucid::Int32& other, const Var& da)
	/// Addition assignment operator for adding Var to Lucid::Int32
{
	return other += da.convert<Lucid::Int32>();
}
...
inline Lucid::Int32 operator -= (Lucid::Int32& other, const Var& da)
	/// Subtraction assignment operator for subtracting Var from Lucid::Int32
{
	return other -= da.convert<Lucid::Int32>();
}
...
inline Lucid::Int32 operator *= (Lucid::Int32& other, const Var& da)
	/// Multiplication assignment operator for multiplying Var with Lucid::Int32
{
	return other *= da.convert<Lucid::Int32>();
}
...
inline Lucid::Int32 operator /= (Lucid::Int32& other, const Var& da)
	/// Division assignment operator for dividing Var with Lucid::Int32
{
	return other /= da.convert<Lucid::Int32>();
}


inline bool operator == (const Lucid::Int32& other, const Var& da)
	/// Equality operator for comparing Var with Lucid::Int32
{
	if (da.isEmpty()) return false;
	return other == da.convert<Lucid::Int32>();
}
...
inline bool operator != (const Lucid::Int32& other, const Var& da)
	/// Inequality operator for comparing Var with Lucid::Int32
{
	if (da.isEmpty()) return true;
	return other != da.convert<Lucid::Int32>();
}
...
inline bool operator < (const Lucid::Int32& other, const Var& da)
	/// Less than operator for comparing Var with Lucid::Int32
{
	if (da.isEmpty()) return false;
	return other < da.convert<Lucid::Int32>();
}
...
inline bool operator <= (const Lucid::Int32& other, const Var& da)
	/// Less than or equal operator for comparing Var with Lucid::Int32
{
	if (da.isEmpty()) return false;
	return other <= da.convert<Lucid::Int32>();
}
...
inline bool operator > (const Lucid::Int32& other, const Var& da)
	/// Greater than operator for comparing Var with Lucid::Int32
{
	if (da.isEmpty()) return false;
	return other > da.convert<Lucid::Int32>();
}
...
inline bool operator >= (const Lucid::Int32& other, const Var& da)
	/// Greater than or equal operator for comparing Var with Lucid::Int32
{
	if (da.isEmpty()) return false;
	return other >= da.convert<Lucid::Int32>();
}
...
inline Lucid::UInt32 operator + (const Lucid::UInt32& other, const Var& da)
	/// Addition operator for adding Var to Lucid::UInt32
{
	return other + da.convert<Lucid::UInt32>();
}


inline Lucid::UInt32 operator - (const Lucid::UInt32& other, const Var& da)
	/// Subtraction operator for subtracting Var from Lucid::UInt32
{
	return other - da.convert<Lucid::UInt32>();
}
...
inline Lucid::UInt32 operator * (const Lucid::UInt32& other, const Var& da)
	/// Multiplication operator for multiplying Var with Lucid::UInt32
{
	return other * da.convert<Lucid::UInt32>();
}
...
inline Lucid::UInt32 operator / (const Lucid::UInt32& other, const Var& da)
	/// Division operator for dividing Var with Lucid::UInt32
{
	return other / da.convert<Lucid::UInt32>();
}


inline Lucid::UInt32 operator += (Lucid::UInt32& other, const Var& da)
	/// Addition assignment operator for adding Var to Lucid::UInt32
{
	return other += da.convert<Lucid::UInt32>();
}
...
inline Lucid::UInt32 operator -= (Lucid::UInt32& other, const Var& da)
	/// Subtraction assignment operator for subtracting Var from Lucid::UInt32
{
	return other -= da.convert<Lucid::UInt32>();
}
...
inline Lucid::UInt32 operator *= (Lucid::UInt32& other, const Var& da)
	/// Multiplication assignment operator for multiplying Var with Lucid::UInt32
{
	return other *= da.convert<Lucid::UInt32>();
}
...
inline Lucid::UInt32 operator /= (Lucid::UInt32& other, const Var& da)
	/// Division assignment operator for dividing Var with Lucid::UInt32
{
	return other /= da.convert<Lucid::UInt32>();
}


inline bool operator == (const Lucid::UInt32& other, const Var& da)
	/// Equality operator for comparing Var with Lucid::UInt32
{
	if (da.isEmpty()) return false;
	return other == da.convert<Lucid::UInt32>();
}
...
inline bool operator != (const Lucid::UInt32& other, const Var& da)
	/// Inequality operator for comparing Var with Lucid::UInt32
{
	if (da.isEmpty()) return true;
	return other != da.convert<Lucid::UInt32>();
}
...
inline bool operator < (const Lucid::UInt32& other, const Var& da)
	/// Less than operator for comparing Var with Lucid::UInt32
{
	if (da.isEmpty()) return false;
	return other < da.convert<Lucid::UInt32>();
}
...
inline bool operator <= (const Lucid::UInt32& other, const Var& da)
	/// Less than or equal operator for comparing Var with Lucid::UInt32
{
	if (da.isEmpty()) return false;
	return other <= da.convert<Lucid::UInt32>();
}
...
inline bool operator > (const Lucid::UInt32& other, const Var& da)
	/// Greater than operator for comparing Var with Lucid::UInt32
{
	if (da.isEmpty()) return false;
	return other > da.convert<Lucid::UInt32>();
}
...
inline bool operator >= (const Lucid::UInt32& other, const Var& da)
	/// Greater than or equal operator for comparing Var with Lucid::UInt32
{
	if (da.isEmpty()) return false;
	return other >= da.convert<Lucid::UInt32>();
}
...
inline Lucid::Int64 operator + (const Lucid::Int64& other, const Var& da)
	/// Addition operator for adding Var to Lucid::Int64
{
	return other + da.convert<Lucid::Int64>();
}


inline Lucid::Int64 operator - (const Lucid::Int64& other, const Var& da)
	/// Subtraction operator for subtracting Var from Lucid::Int64
{
	return other - da.convert<Lucid::Int64>();
}
...
inline Lucid::Int64 operator * (const Lucid::Int64& other, const Var& da)
	/// Multiplication operator for multiplying Var with Lucid::Int64
{
	return other * da.convert<Lucid::Int64>();
}
...
inline Lucid::Int64 operator / (const Lucid::Int64& other, const Var& da)
	/// Division operator for dividing Var with Lucid::Int64
{
	return other / da.convert<Lucid::Int64>();
}


inline Lucid::Int64 operator += (Lucid::Int64& other, const Var& da)
	/// Addition assignment operator for adding Var to Lucid::Int64
{
	return other += da.convert<Lucid::Int64>();
}
...
inline Lucid::Int64 operator -= (Lucid::Int64& other, const Var& da)
	/// Subtraction assignment operator for subtracting Var from Lucid::Int64
{
	return other -= da.convert<Lucid::Int64>();
}
...
inline Lucid::Int64 operator *= (Lucid::Int64& other, const Var& da)
	/// Multiplication assignment operator for multiplying Var with Lucid::Int64
{
	return other *= da.convert<Lucid::Int64>();
}
...
inline Lucid::Int64 operator /= (Lucid::Int64& other, const Var& da)
	/// Division assignment operator for dividing Var with Lucid::Int64
{
	return other /= da.convert<Lucid::Int64>();
}


inline bool operator == (const Lucid::Int64& other, const Var& da)
	/// Equality operator for comparing Var with Lucid::Int64
{
	if (da.isEmpty()) return false;
	return other == da.convert<Lucid::Int64>();
}
...
inline bool operator != (const Lucid::Int64& other, const Var& da)
	/// Inequality operator for comparing Var with Lucid::Int64
{
	if (da.isEmpty()) return true;
	return other != da.convert<Lucid::Int64>();
}
...
inline bool operator < (const Lucid::Int64& other, const Var& da)
	/// Less than operator for comparing Var with Lucid::Int64
{
	if (da.isEmpty()) return false;
	return other < da.convert<Lucid::Int64>();
}
...
inline bool operator <= (const Lucid::Int64& other, const Var& da)
	/// Less than or equal operator for comparing Var with Lucid::Int64
{
	if (da.isEmpty()) return false;
	return other <= da.convert<Lucid::Int64>();
}
...
inline bool operator > (const Lucid::Int64& other, const Var& da)
	/// Greater than operator for comparing Var with Lucid::Int64
{
	if (da.isEmpty()) return false;
	return other > da.convert<Lucid::Int64>();
}
...
inline bool operator >= (const Lucid::Int64& other, const Var& da)
	/// Greater than or equal operator for comparing Var with Lucid::Int64
{
	if (da.isEmpty()) return false;
	return other >= da.convert<Lucid::Int64>();
}
...
inline Lucid::UInt64 operator + (const Lucid::UInt64& other, const Var& da)
	/// Addition operator for adding Var to Lucid::UInt64
{
	return other + da.convert<Lucid::UInt64>();
}


inline Lucid::UInt64 operator - (const Lucid::UInt64& other, const Var& da)
	/// Subtraction operator for subtracting Var from Lucid::UInt64
{
	return other - da.convert<Lucid::UInt64>();
}
...
inline Lucid::UInt64 operator * (const Lucid::UInt64& other, const Var& da)
	/// Multiplication operator for multiplying Var with Lucid::UInt64
{
	return other * da.convert<Lucid::UInt64>();
}
...
inline Lucid::UInt64 operator / (const Lucid::UInt64& other, const Var& da)
	/// Division operator for dividing Var with Lucid::UInt64
{
	return other / da.convert<Lucid::UInt64>();
}


inline Lucid::UInt64 operator += (Lucid::UInt64& other, const Var& da)
	/// Addition assignment operator for adding Var to Lucid::UInt64
{
	return other += da.convert<Lucid::UInt64>();
}
...
inline Lucid::UInt64 operator -= (Lucid::UInt64& other, const Var& da)
	/// Subtraction assignment operator for subtracting Var from Lucid::UInt64
{
	return other -= da.convert<Lucid::UInt64>();
}
...
inline Lucid::UInt64 operator *= (Lucid::UInt64& other, const Var& da)
	/// Multiplication assignment operator for multiplying Var with Lucid::UInt64
{
	return other *= da.convert<Lucid::UInt64>();
}
...
inline Lucid::UInt64 operator /= (Lucid::UInt64& other, const Var& da)
	/// Division assignment operator for dividing Var with Lucid::UInt64
{
	return other /= da.convert<Lucid::UInt64>();
}


inline bool operator == (const Lucid::UInt64& other, const Var& da)
	/// Equality operator for comparing Var with Lucid::UInt64
{
	if (da.isEmpty()) return false;
	return other == da.convert<Lucid::UInt64>();
}
...
inline bool operator != (const Lucid::UInt64& other, const Var& da)
	/// Inequality operator for comparing Var with Lucid::UInt64
{
	if (da.isEmpty()) return true;
	return other != da.convert<Lucid::UInt64>();
}
...
inline bool operator < (const Lucid::UInt64& other, const Var& da)
	/// Less than operator for comparing Var with Lucid::UInt64
{
	if (da.isEmpty()) return false;
	return other < da.convert<Lucid::UInt64>();
}
...
inline bool operator <= (const Lucid::UInt64& other, const Var& da)
	/// Less than or equal operator for comparing Var with Lucid::UInt64
{
	if (da.isEmpty()) return false;
	return other <= da.convert<Lucid::UInt64>();
}
...
inline bool operator > (const Lucid::UInt64& other, const Var& da)
	/// Greater than operator for comparing Var with Lucid::UInt64
{
	if (da.isEmpty()) return false;
	return other > da.convert<Lucid::UInt64>();
}
...
inline bool operator >= (const Lucid::UInt64& other, const Var& da)
	/// Greater than or equal operator for comparing Var with Lucid::UInt64
{
	if (da.isEmpty()) return false;
	return other >= da.convert<Lucid::UInt64>();
}
